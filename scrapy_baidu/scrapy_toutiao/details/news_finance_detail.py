...
for i in range(len(hot_details)):
    ...
    # hot = hot_details[0][1]
    # type = hot_details[0][3]
    # title = hot_details[0][2]
    print(hot)
    try:
        browser.get(hot) #热点
    ...
    if href:
        ...
        for video in video_html:
            ...
            #上传视频
            os_path = oss_video_pre(fileName)
            if os_path:
