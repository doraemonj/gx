...
start_url = 'https://www.toutiao.com/api/pc/list/feed/?offset=0&category=pc_profile_channel&disable_raw_data=true&app_name=toutiao_web&max_behot_time='
url = 'https://www.toutiao.com'
# url = 'https://www.toutiao.com/group/7152375775096734249/'

headers={
    'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'
}
# cookies = {'tt_webid':'6649949084894053895'} # 此处cookies可从浏览器中查找，为了避免被头条禁止爬虫
cookies = {'tt_webid':'7152518804760610311'} # 此处cookies可从浏览器中查找，为了避免被头条禁止爬虫
...
def main(max_behot_time, title, source_url, s_url, source, media_url):   # 主函数
    for i in range(3):   # 此处的数字类似于你刷新新闻的次数，正常情况下刷新一次会出现10条新闻，但夜存在少于10条的情况；所以最后的结果并不一定是10的倍数
        ...
        demo = getdata('https://www.toutiao.com/api/pc/list/feed?offset=0&'+'&max_behot_time_tmp=0'+'&category=pc_profile_channel&disable_raw_data=true&aid=24&app_name=toutiao_web'+'&tadrequire=true&as='+ascp['as']+'&cp='+ascp['cp'], headers, cookies)
        print(demo)
        time.sleep(1)
        ...
        max_behot_time = 0  # 获取下一个链接的max_behot_time参数的值
