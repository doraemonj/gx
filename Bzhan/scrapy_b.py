...
def save(title, audio_url, video_url):
    ...
    with open('b_sounds.mp3', mode='wb') as f:
        f.write(audio_content)
    with open('b_video.mp4', mode='wb') as f:
...
def merge_data(video_name):
    ...
    com = f'C:\\Users\\vvv\Downloads\\ffmpeg-4.3.1-2021-01-01-essentials_build\\bin\\ffmpeg.exe -i "b_sounds.mp3" -i "b_video.mp4" -acodec copy -vcodec copy {video_filePath}{video_name}.mp4'
    print(com)
    os.system(com)
    ...
    if ':' in video_time:
        ...
        if int(v_time) < 4 and type == 9:
            ...
            if os_path:
                ...
                os.remove('D:\\video_src\\'+video_name)
                os.remove('C:\\Users\\vvv\PycharmProjects\\news_jot\Bzhan\\b_sounds.mp3')
                os.remove('C:\\Users\\vvv\PycharmProjects\\news_jot\Bzhan\\b_video.mp4')

        elif 4 <= int(v_time) < 20 and type == 9:
            video_info = get_video_info(url)
